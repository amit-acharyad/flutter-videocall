...
import 'package:videocall/videocall/controller/webRTCVideoCallController.dart';
...
class VideoCallChecker {
  static final currentUserId = AuthenticationRepository.instance.user!.uid;
  static final Rx<VideoCallModel> currentCall = VideoCallModel.empty.obs;
